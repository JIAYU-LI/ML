...
from data_provider64 import load_organized_data_info
from data_provider64 import train_val_dirs_generators
...
def _train_model():
    ...
    model.fit_generator(
        ...
        callbacks=[ModelCheckpoint(CNN_MODEL_FILE, save_best_only=True), EarlyStopping(monitor='val_loss', patience=20)],
        verbose=2)
