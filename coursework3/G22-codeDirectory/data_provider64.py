...
ROOT_DIR = join(dirname(dirname(__file__)), 's1717961')
...
def train_val_dirs_generators(
        batch_size, dir_tr, dir_val, target_size=(64, 64)):
...
class PairsImageDataGenerator(ImageDataGenerator):
    ...
    def flow_from_directory(
            self, dir_, target_size=(64, 64), color_mode='rgb',
...
def load_organized_data_info(imgs_dim_1d, multi_crop=False): #deactivate this function due to limited memory
